...
　●button・glink 等にもSEを指定できます。（V2.00以降）
　　
　◆出来ない事
...
　
　② save.html、load.html、menu.html、backlog.html をテキストエディタで開き、
　　一番下に下記コードを記入してください。
...
　　　テーマ一括変換プラグインを使ってる場合など、ファイルの場所は固定ではありません。
...
■更新履歴
-------------------------------------------------------------------------------------------------
　2021/07/30　ver2.01  htmlファイル同梱停止。導入手順変更。機能変更なし。
